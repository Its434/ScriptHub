...
local Window = Rayfield:CreateWindow({
   Name = "MIC UP 🔊 | @movement.exe",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "MIC UP 🔊",
   LoadingSubtitle = "by 434",
   ...
   KeySettings = {
      Title = "Mic up",
      Subtitle = "Key System",
      Note = "The key is Easy Guess it!", -- Use this to tell the user how to get a key
      FileName = "Key", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = false, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"434"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
Rayfield:Notify({
   Title = "Script Enjected...",
   Content = "434 is Daddy",
   Duration = 5,
   Image = nil,
...
Terrain:FillBlock(CFrame.new(66, -10, 72.5), Vector3.new(1000, 16, 1000), Enum.Material.Asphalt)
...
local MainTab = Window:CreateTab("🔞Troll", nil) -- Title, Image
